$(document).ready(function () {
  ...
  function customSelect() {
    ...
    for (i = 0; i < x.length; i++) {
      var select = x[i].getElementsByClassName('select-selected')[0];
  ...
  function resizePageOndropDown() {
    $('.select-selected').click(function () {
      if ($(this).parents('#page-2').length > 0) {
        var parentPage = $(this).parents('#page-2');
      ...
      if (allow_add) {
        ...
        <div class="place-wrapper">
          <div class="row mx-0">
              ...
              <!-- <div class="col-12">
          <div class="trip-input-wrapper mb-0">
              <label class="input-icon"><img
                      src='../images/input-icons/destination.png'></label>
              <div class="new-trip-input" required
                  style="height: auto; min-height: 45px">
                  <div class="places-wrapper">
                      <span class="place">
                          place <span class="close"><img
                                  src='../images/icons/close.png'></span>
                      </span>
                      <span class="place">
                          place <span class="close"><img
                                  src='../images/icons/close.png'></span>
          ...
          <span class="places-citation">Places you enter first
              appears first in
              the program digram</span>
      </div> -->
          </div>
      </div>
      `)
